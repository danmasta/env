describe('Env', () => {
    ...
    it('should get variables', () => {
        ...
        expect(env.get('TEST_PORT', { native: false })).to.be.a('string');
        expect(env.get('TEST_PORT', { string: true })).to.be.a('string');
    });

    it('should set variables that are not set', () => {
    ...
    it('should overwrite variables', () => {
        env.set('NODE_ENV', 'development', { overwrite: true });
        expect(env.get('NODE_ENV')).to.equal('development');
        env.set('NODE_ENV', 'test', { overwrite: true });
    });

    it('should coerce values to native types', () => {
